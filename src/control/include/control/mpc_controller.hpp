// copyright
#ifndef SRC_CONTROL_INCLUDE_CONTROL_MPC_CONTROLLER_HPP_
#define SRC_CONTROL_INCLUDE_CONTROL_MPC_CONTROLLER_HPP_
#include <Eigen/Dense>
#include <string>
#include <fstream>
#include <memory>
...
class MPCController {
 ...
 private:
  ...
  Eigen::MatrixXd matrix_c_;   // constant matrix
  Eigen::MatrixXd matrix_cd_;  // constant matrix (discrete-time)
...
#endif  // SRC_CONTROL_INCLUDE_CONTROL_MPC_CONTROLLER_HPP_