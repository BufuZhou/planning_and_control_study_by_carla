...
file_handle_spawn_points =open('spawn_points_Town01_01.txt',mode='w+')
...
origin = carla.Location(spawn_points[16].location)
destination = carla.Location(spawn_points[254].location)
print("\n=====================================spawn_points=================================")
print(spawn_points[16])


# there are other funcations can be used to generate a route in GlobalRoutePlanner.
w1 = grp.trace_route(origin, destination) 
i = 0
file_handle=open('reference_line_Town01_01.txt',mode='w+')
for w in w1:
    if i % 10 == 0:
